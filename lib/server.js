...
//API Handlers
const userHandler = require('./api/user-handler')
const menuHandler = require('./api/menu-handler')
const shoppingCart = require('./api/shopping-cart-handler')
const notFoundHandler = require('./api/not-found-handler')
const orderHandler = require('./api/order-handler')
const tokenHandler = require('./api/token-handler')

//Frontend Handlers 
const indexHandler = require('./web/index-handler')
const mediaHandler = require('./web/media-handler')
const faviconHandler = require('./web/favicon-handler')
...
server.unifiedServer = function(request, response){
    ...
    request.on('end', function(){
        ...
        chosenHandler = trimmedPath.indexOf('public/') > -1 ? mediaHandler : chosenHandler;
